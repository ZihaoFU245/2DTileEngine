 ...
 * the code.
 * <p>
 * You are free to (and encouraged to) to create and add your own tiles to this file. This file will
...
public class Tileset {
    ...
    /**
     * Sentinel tile used to mark coordinates that do not exist on a {@code TileMap}.
     * A {@code TileMap} returns {@code VOID} when queried outside its 2D tile array
     * instead of {@link #NOTHING}. Game entities should never spawn on or move
     * into this tile. Collision and movement logic may treat it as an impassable
     * boundary or ignore it entirely. By contrast, {@link #NOTHING} represents an
     * in-bounds, traversable empty tile that may be replaced or occupied during
     * gameplay.
     */
    public static final TETile VOID = new TETile(' ', Color.black, Color.black, "void", 13);
